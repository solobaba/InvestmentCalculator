...
var processEntries = function() {
    ...
    if (isNaN(investment) || investment <= 0 || investment > 1000000) {
    	error = "Investment amount must be a number greater than zero and less than or equal to 1,000,000";
    	$("investment").focus();
    }
    ...
    else if (isNaN(years) || years <= 0 || years > 12) {
    	error = "Tenor must be a number greater than zero and less than 12";
    	$("years").focus();
    }
